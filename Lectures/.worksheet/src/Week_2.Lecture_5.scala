...
object Lecture_5
{;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(63); 
  ...
  x.sub(y).sub(z);System.out.println("""res3: Week_2.Rational = """ + $show(res$3))}
}
